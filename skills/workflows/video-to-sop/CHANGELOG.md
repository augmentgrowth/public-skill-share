[2026-07-16] Fixed macOS virtualenv detection, encoded standing Gemini-vision routing, and documented one-packet multi-workstream SOP synthesis after the live Entrance Solutions acceptance run.
[2026-07-16] Added optional REFERENCE_DOCX rendering so client SOPs can inherit an approved Word style while retaining the validated Markdown round trip.
